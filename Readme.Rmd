...
```{r fmz, fig.cap = "Simple map of Fisheries Management Zones 10,11, and 12."}
...
```{r district, fig.cap = "Simple map of Aurora and Guelph Districts."}
...
```{r conservation_authority, fig.cap = "Simple map of Saugeen and Maitland Con. Auth."}
...
```{r waterbody, fig.cap = "Simple map of some selected waterbodies."}
...
```{r parks, fig.cap = "Simple map of some selected provincial parks." }
...
```{r townships, fig.cap = "Simple map of some selected townships."}
